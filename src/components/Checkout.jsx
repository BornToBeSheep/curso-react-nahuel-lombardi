...
import { addDoc, collection, updateDoc , getFirestore, getDoc, doc } from "firebase/firestore";

const Checkout = () =>{
    const {cart, clear, toPay} = useContext(CartContext);
                    ...
                    <table className="table">                                
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className="text-end"><b>${toPay()}</b></td>
                            </tr>
                        </tbody>
                    </table>    
                </div>
